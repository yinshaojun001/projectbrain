...
from projectbrain_runtime.intake import build_project_intake_session, submit_project_intake_answer
...
class ProjectBrainRuntime:
    ...
    def answer_project_intake(
        ...
        *,
        ...
        intake = submit_project_intake_answer(
            session=session,
